...
public record GetAllPaveQuery() : IRequest<IEnumerable<PaveResponseDto>>;

public class GetAllPaveQueryHandler : IRequestHandler<GetAllPaveQuery, IEnumerable<PaveResponseDto>>
{
    private readonly IApplicationDbContext _context;

    public GetAllPaveQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<IEnumerable<PaveResponseDto>> Handle(GetAllPaveQuery request, CancellationToken cancellationToken)
    {
