...
public record GetAllDecideSessionsQuery() : IRequest<IEnumerable<DecideSessionResponseDto>>;

public class GetAllDecideSessionsQueryHandler : IRequestHandler<GetAllDecideSessionsQuery, IEnumerable<DecideSessionResponseDto>>
{
    private readonly IApplicationDbContext _context;

    public GetAllDecideSessionsQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<IEnumerable<DecideSessionResponseDto>> Handle(GetAllDecideSessionsQuery request, CancellationToken cancellationToken)
    {
