                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 sm:gap-6">
                        ...
                        <button
                            ...
                            id="landing-offline-btn"
                            className="flex items-center gap-1.5 px-3 py-2 rounded-xl border-2 border-amber-400/50 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 font-bold text-sm transition-all whitespace-nowrap"
                            title="Use offline without an account"
                        >
                            <WifiOff size={14} />
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8 sm:gap-16 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap gap-2.5 sm:gap-3">
                                ...
                                <button
                                    onClick={() => navigate('/offline')}
                                    id="landing-try-offline-btn"
                                    className="flex items-center justify-center gap-2 border-2 border-amber-400 text-amber-700 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 font-bold text-sm sm:text-base px-5 sm:px-8 py-2.5 rounded-xl transition-all"
                                >
                                    <Monitor size={16} />
                                    ✈️ Try as Pilot (Offline)
                                </button>
                            </div>
                        </div>
