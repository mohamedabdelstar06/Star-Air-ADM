...
export function LoginPage() {
    ...
    return (
        <div className="min-h-dvh flex bg-white">
            ...
            {/* Right — Login Form */}
            <div className="w-full lg:w-[55%] flex flex-col justify-center items-center p-6 sm:p-10 lg:p-12 bg-slate-50">
                {/* Mobile logo */}
                ...
                <div className="w-full max-w-xl animate-slide-up" style={{ animationDelay: '100ms' }}>
                    <div className="bg-white rounded-2xl p-7 sm:p-9 shadow-sm border border-slate-200">
                        <h2 className="text-2xl font-black text-slate-900 mb-1">Welcome back</h2>
                        <p className="text-base font-medium text-slate-600 mb-3">Sign in to your STAR Air ADM account</p>
                        
                        <div className="mb-7 p-5 bg-blue-50 border border-blue-200 rounded-xl text-base text-blue-950">
                            <p className="font-black text-lg mb-2">👋 Hello Dr. Mohamed Saad,</p>
                            <p className="mb-1.5"><strong>If you are a pilot:</strong> pilot@starair.com / Pilot@123!</p>
                            <p><strong>If you are admin:</strong> admin@starair.com / Admin@123!</p>
                        </div>

                        <form onSubmit={handleLogin} className="space-y-5" noValidate>
                            {/* Email */}
                            <div>
                                <label className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-2.5 block" htmlFor="email">
                                    Email Address
                                </label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        autoComplete="email"
                                        autoFocus
                                        className="w-full pl-11 pr-4 py-3.5 bg-white border-2 border-slate-200 rounded-xl text-slate-900 font-semibold focus:outline-none focus:border-primary-500 transition-colors placeholder:text-slate-400 text-[15px]"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    <label className="text-sm font-bold text-slate-800 uppercase tracking-wider" htmlFor="password">
                                        Password
                                    </label>
                                    <Link
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-11 py-3.5 bg-white border-2 border-slate-200 rounded-xl text-slate-900 font-semibold focus:outline-none focus:border-primary-500 transition-colors placeholder:text-slate-400 text-[15px]"
                                    />
                                    <button
                                        type="button"
                                        tabIndex={-1}
                            ...
                            {/* Error */}
                            {displayError && (
                                <div className="flex items-start gap-2 px-4 py-3.5 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm font-semibold animate-fade-in">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 px-4 rounded-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed shadow-md active:scale-[0.98] text-[15px] mt-2"
                            >
